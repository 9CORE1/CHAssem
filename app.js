    ...
    if (adminToggle) {
        adminToggle.addEventListener('click', () => {
            if (isAdminMode) {
                ...
                const navActivities = document.getElementById('nav-activities');
                if (navActivities) navActivities.style.display = 'none';
...
// ==========================================================================
// Load-time Popup & Popup configuration (Admin Mode)
// ==========================================================================
...
function checkAndShowPopup() {
    ...
    if (hideTime) {
        ...
        if (now < parseInt(hideTime, 10)) {
            // Still within 24 hours of hiding
            return;
        }
    }
    ...
    if (popupConfig.linkUrl) {
        ...
        applyLinkEl.style.display = 'flex';
        hasButtons = true;
    } else {
...
document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('.nav-menu a, .logo').forEach(link => {
        link.addEventListener('click', () => {
            if (!link.closest('#nav-project-mgmt') && !link.closest('#nav-activities')) {
